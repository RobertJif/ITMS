<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CCTVActivity.aspx.cs" Inherits="Activity.Pages.CCTVActivity" %>
            ...
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        --%>
                            <dx:ASPxButton ID="btnNew" runat="server" Text="Add CCTV Activity" Theme="Mulberry" OnClick="btnNew_Click" CausesValidation="false"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <dx:ASPxComboBox ID="id" runat="server" ValueType="System.String" Width="220px" Theme="Mulberry" />                            
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                        <dx:ASPxGridView ID="grid" runat="server" Settings-GridLines="Both"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="VideoRecorderName" VisibleIndex="1" />
                                ...
                                <dx:GridViewDataTextColumn FieldName="CameraName" VisibleIndex="2">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="ShutdownID" VisibleIndex="0" Visible="false">
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
                    </div>                    
